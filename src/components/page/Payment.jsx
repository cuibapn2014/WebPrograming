    ...
    <div className="container mx-auto">
      ...
      <div className="text-left">
        ...
        <div className="ml-7">
          <p className="mb-1">
            {" "}
            👉 Khách hàng có thể tới cửa hàng của CN mua hàng để thanh toán trực
            tiếp
          </p>
          <p className="mb-1">
            {" "}
      ...
      <div className="text-left mt-4">
        ...
        <div className="ml-7">
          <p className="mb-1">
            {" "}
            👉 Dành cho khách hàng đặt hàng và thanh toán online - Chuyển khoản
            giá trị đơn hàng thông qua các App chuyển khoản (banking) :
          </p>
          <p className="mb-1">
      ...
      <div className="bg-slate-50 border-dashed border-8 border-[#5b9bd5] flex flex-col md:flex-row items-center w-[70%] mx-auto p-4 mt-8">
        ...
        <div className="md:w-3/5 w-full mt-2">
          ...
          <p className="mb-3">
            <span className="font-semibold">Số tài khoản : </span>1909 2878 677
            098
          </p>
          <p className="mb-3">
            <span className="font-semibold">Chủ tài khoản : </span> Lê Hoàng Chí
            Nhân
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-50 border-dashed border-8 border-[#5b9bd5] flex flex-col md:flex-row items-center w-[70%] mx-auto p-4 mt-8">
        ...
        <div className="md:w-3/5 w-full mt-2">
          ...
          <p className="mb-3">
            <span className="font-semibold">Số tài khoản : </span>0909 9078 677
            980
          </p>
          <p className="mb-3">
            <span className="font-semibold">Chủ tài khoản : </span> Lê Hoàng Chí
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          <p className="mb-1">
            ...
            hoặc phần còn lại (sau khi khách hàng đã đặt cọc trước 10% với hóa
            đơn trên 15tr đồng).
          </p>
          <p className="mb-1">
            {" "}
