    ...
    <div className="container mx-auto">
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          ...
          <p className="mb-1">
            {" "}
            👉 Với các đơn hàng giá trị dưới 1 triệu đồng , Sao Chổi sẽ tính phí
            giao hàng như sau :
          </p>
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          ...
          <p className="mb-1">
            {" "}
            👉 Với hàng hóa là PC trên 15 triệu , quý khách vui lòng cọc 10% giá
            trị PC để bảo đảm nhận hàng.
          </p>
        </div>
      </div>
      {/* ship in HCM */}
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          <p className="mb-1">
            {" "}
            👉 Với các đơn hàng đi tỉnh, khách hàng vui lòng thanh toán 100% hóa
            đơn giúp Sao Chổi nhé.
          </p>
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          ...
          <p className="mb-1">
            {" "}
            👉 Nếu nhà khách hàng gần chành xe có thể ra chành xe nhận hàng hoặc
            chành xe giao trực tiếp trên các cung đường xe đi có sẵn.
          </p>
          <p className="mb-1">
            {" "}
