    ...
    >
      ...
      <div className="text-left mb-12">
        ...
        <span className="mb-3 font-medium ml-3 block">
          {" "}
          Khi có nhu cầu bảo hành sản phẩm, khách hàng vui lòng liên hệ Sao Chổi
          PC qua các hình thức sau :
        </span>
        <div className="ml-7">
        ...
        <div className="ml-7">
          <p className="mb-1">
            {" "}
            👉 Sao Chổi sẽ chủ động liên hệ, bàn giao sản phẩm đã được bảo hành
            đến cho khách hàng.
          </p>
          <p className="mb-1">
            {" "}
            👉 Quý khách vui lòng đọc thông tin, số liện thoại lúc nhận sản phẩm
            trả bảo hành.
          </p>
        </div>
        <div className="mt-10">
          ...
          <div className="ml-7">
            <p className="mb-1">
              {" "}
              👉 Qui trình tiếp nhận, kiểm tra sản phẩm tại chỗ, khách hàng được
              giám sát.
            </p>
            <p className="mb-1">
              {" "}
            ...
            <p className="mb-1">
              {" "}
              👉 Các sản phẩm Gaming Gear & linh kiện máy tính trong 30 ngày đầu
              tiên ( trừ màn hình là 7 ngày ) nếu phát sinh lỗi kĩ thuật của sản
              phẩm sẽ được đổi mới ngay lập tức với điều kiện sản phẩm bị lỗi
              phải còn giữ nguyên tem bảo hành, hộp hoặc seal sản phẩm. Các sản
              phẩm có tương tác vật lý làm thay đổi hình dáng bên ngoài và cấu
              trúc bên trong của sản phẩm sẽ không được đổi mới. Các sản phẩm
              này sẽ được bảo hành theo chính sách của hãng.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-left">
        ...
        <div className="ml-7">
          <p className="mb-1">
            ...
            hết hạn bảo hành. Tem bảo hành trên sản phẩm bị rách, mờ hoặc có dấu
            hiệu sửa đổi, làm giả.
          </p>
          <p className="mb-1">
            {" "}
            👉 Không bảo hành sản phẩm Mainboard bị cong hoặc gãy chân, hoặc vi
            phạm các qui định khác của nhà sản xuất.
          </p>
          <p className="mb-1">
            {" "}
            👉 Sản phẩm biến dạng, trầy xước, bể, mẻ, cong, xì tụ, cháy nổ chip,
            bị chất lỏng đổ vào.
          </p>
          <p className="mb-1">
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          <p className="mb-1">
            👉 Sản phẩm Gaming Gear: 3 – 5 ngày không tính thứ 7 chủ nhật – các
            ngày lễ tết.
          </p>
          <p className="mb-1">
            {" "}
          ...
          <p className="mb-1">
            👉 Trường hợp sản phẩm nằm ngoài chính sách bảo hành, Sao Chổi sẽ đề
            xuất sửa chữa có tính phí nếu phát sinh chi phí sửa chữa.
          </p>
          <p className="mb-1">👉 Sản phẩm đặt trong môi trường Ôxy hóa.</p>
          <p className="mb-1">
            {" "}
            👉 Trường hợp nếu sản phẩm lỗi do người sử dụng không có khả năng
            sửa chữa được, Sao Chổi sẽ hoàn trả lại sản phẩm lỗi cho khách hàng.
          </p>
        </div>
      </div>
      {/* duration maintain */}
      ...
      <div className="text-left mt-8">
        ...
        <div className="ml-7">
          <p className="mb-1">
            {" "}
            👉 Phí 5% trên hóa đơn sản phẩm trả của Sao Chổi ( từ ngày thứ 1 đến
            ngày thứ 7 ) : máy chưa qua sử dụng .
          </p>
          <p className="mb-1">
        ...
        <div className="ml-7 mt-4">
          ...
          <p className="mb-1">
            👉 Bắt buộc phải đầy đủ các giấy tờ – phụ kiện kèm theo trong thùng
            máy và chứng từ mà Sao Chổi đã xuất như lúc khách hàng nhận hàng (
            bao gồm cả quà tặng ).
          </p>
          <p className="mb-1">
            {" "}
            👉 Sao Chổi sẽ hoàn tiền trễ nhất trong vòng 48h dưới hình thức tiền
            mặt hoặc chuyển khoản theo yêu cầu của khách hàng.
          </p>
          <p className="mb-1">
            {" "}
      ...
      <div className="text-left">
        ...
        <div className="ml-7">
          <p className="mb-1">
            ...
            hoặc ngay khi nhận hàng. Sao Chổi sẽ không chịu trách nhiệm đối với
            hàng hóa bị lỗi không phải do nhà sản xuất gây ra sau khi khách Hàng
            đã nhận hàng.
          </p>
          <p className="mb-1">
            {" "}
          ...
          <p className="mb-1">
            {" "}
            👉 Đổi mới hàng hóa trong vòng 30 ngày ( trừ màn hình là 7 ngày ) kể
            từ ngày giao hàng . Hàng hóa bị lỗi phải được xác định là lỗi kỹ
            thuật do nhà sản xuất (cần có xác nhận của Hãng đối với một số
            ...
            theo phải còn mới, hộp/thùng còn nguyên vẹn, đầy đủ chứng từ như khi
            Sao Chổi giao hàng.
          </p>
          <p className="mb-1">
      ...
      <div className="text-left">
        ...
        <div className="ml-7">
          ...
          <p className="mb-1">
            {" "}
            👉 Sản phẩm không còn mới 100%: trầy xước, móp méo, không còn nguyên
            vẹn như lúc đầu, không đầy đủ phụ kiện, thùng/hộp sản phẩm.
          </p>
          <p className="mb-1">
            {" "}
            👉 Các logo của laptop, tem của hãng hay của Sao Chổi đều phải đảm
            bảo nguyên vẹn, không bị bung hay tháo rời dưới mọi hình thức trong
            thời gian đổi trả máy. Khách hàng tuyệt đối không được dán màn hình
            trong thời gian đổi trả máy để đảm bảo màn hình không bị xước, nếu
            khách hàng tự ý dán thì nhờ khách hàng tự lấy ra.
          </p>
          <p className="mb-1">
            👉 Những lí do cảm tính như: “Tôi không thích máy này nữa”, “Máy này
            quá yếu”, “Máy này màn hình không như tôi mong muốn”…
          </p>
        </div>
      </div>
      {/* resolve lie product */}
