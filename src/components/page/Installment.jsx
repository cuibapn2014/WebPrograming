  ...
  return (
    ...
    >
      ...
      <p className="text-left">
        Khách hàng ghé Showroom CN đem theo giấy tờ theo đúng hạn mức muốn được
        trả góp (đề cập ở phía dưới) , Sao Chổi sẽ có chuyên viên ngân hàng HD
        SAISON tư vấn và thực hiện thủ tục tại chỗ nhanh chóng cho quý khách.
      </p>

      {/* Chính sách quy định */}
      <div className="text-left mt-5">
        <h3 className="font-medium text-lg mb-2"> 👉 Chính sách quy định : </h3>
        <p className="flex items-center ml-2">
          <span className="font-semibold text-2xl mr-1">+</span> Khách hàng phải
          nằm trong độ tuổi từ 19 - 70 tuổi.
        </p>
        <p className="flex items-center ml-2">
      ...
      <div className="text-left mt-5">
        ...
        <div className="mb-5">
          <h4 className="text-[#1435c3] text-xl font-semibold">
            <span className="text-[red] mr-1">♦</span> Đơn hàng từ 2 - 12 Triệu
          </h4>
          <p className=" my-3">
            <span className="font-semibold text-2xl mr-1">+</span>
            Khách hàng cần đem <span className="font-semibold">
              CMND/CCCD
            </span>{" "}
            (không bắt buộc thẻ gắn chip)
          </p>
        </div>
        {/* 2 -12 */}
        {/* 2 -20 */}
        <div className="mb-5">
          <h4 className="text-[#1435c3] text-xl font-semibold mb-4">
            <span className="text-[red] mr-1">♦</span> Đơn hàng từ 2 - 20 Triệu
          </h4>
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
            đem <span className="font-semibold mx-1"> CMND/CCCD.</span>
          </p>
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
            đem <span className="font-semibold mx-1"> Sổ hậu khẩu</span>( hoặc{" "}
            <span className="font-semibold mx-1">Giấy phép lấy xe</span>).
          </p>
          <p>
        ...
        <div className="mb-5">
          <h4 className="text-[#1435c3] text-xl font-semibold mb-4">
            <span className="text-[red] mr-1">♦</span> Đơn hàng từ 20 - 30 Triệu
          </h4>
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
            đem <span className="font-semibold mx-1"> CMND/CCCD.</span>
          ...
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
            đem <span className="font-semibold mx-1"> Sổ hộ khẩu</span>( hoặc{" "}
            <span className="font-semibold mx-1">Giấy phép lấy xe</span>).
          </p>
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
          ...
          <p>
            <span className="font-semibold text-[red]"> ! Lưu ý : </span> Khách
            hàng cần trả trước <span className="font-semibold ">30%</span> giá
            trị đơn hàng.
          </p>
        </div>
        {/* 20 - 30 */}
        ...
        <div className="mb-5">
          <h4 className="text-[#1435c3] text-xl font-semibold mb-4">
            <span className="text-[red] mr-1">♦</span> Đơn hàng từ 30 - 60 Triệu
          </h4>
          <p className="">
            <span className="font-semibold text-2xl mr-1">+</span>Khách hàng cần
            đem <span className="font-semibold mx-1"> CMND/CCCD.</span>
          ...
          <p className="">
            ...
            đem{" "}
            <span className="font-semibold mx-1">
              sao kê tài khoản ngân hàng nhận lương 3 tháng gần nhất / Hợp đồng
      ...
      <div className="text-left">
        ...
        <p className="flex items-center">
          <span className="font-semibold text-2xl mr-1">+</span> Thời gian duyệt
          hồ sơ: từ 10 - 20 phút.
        </p>
        <p className="flex items-center">
          <span className="font-semibold text-2xl mr-1">+</span> HD Saison chỉ
          kiểm tra xong giấy tờ gốc và gửi lại, không giữ bất cứ giấy tờ gì của
          khách hàng.
        </p>
        <p className="flex items-center">
          <span className="font-semibold text-2xl mr-1">+</span> Khách hàng vẫn
          nhận đủ các chương trình khuyến mãi mà Sao Chổi đang áp dụng đối với
          mọi sản phẩm.
        </p>
      </div>
      {/* Finnish  Information*/}
      ...
      <div>
        ...
        <div className="text-left ml-6">
          <p className="mb-1">
            {" "}
            👉 Chỉ cần có thẻ tín dụng là đăng kí được chương trình trả góp 0%.
          </p>
      ...
      <div className="mt-10">
        ...
        <div className="text-left ml-6">
          ...
          <p className="mb-1">
            {" "}
            👉 Khách hàng cần phải có thẻ tín dụng trong nước và đủ hạn mức khả
            dụng để thanh toán trả góp.
          </p>
        </div>
      </div>
      {/* condition apply */}
      ...
      <div className="mt-10">
        ...
        <div className="text-left ml-6">
          ...
          <p className="mb-1">
            ...
            tính theo số tháng khách hàng muốn trả góp và tùy thuộc ngân hàng sẽ
            có phí khác nhau :
          </p>
        </div>
        <div className="text-left mt-5">
          <p> 📌​​​​​​ Biểu phí dịch vụ để tiến hành chuyển đổi trả góp 0% :</p>
          <div>
          ...
          <p className="mt-2 mb-1">
            ...
            giá trị giao dịch đối với kỳ hạn 3, 9, 12 tháng và miễn phí dịch vụ
            quản lý đối với kỳ hạn 6 tháng.
          </p>
          <p className="mt-2 mb-1">
            (**) Đối với Techcombank: Theo quy định của ngân hàng Techcombank,
            ngân hàng sẽ thu chủ thẻ phí chuyển đổi giao dịch trả góp là
            1,1%*Giá trị giao dịch (đã bao gồm VAT, tối thiểu 100.000VNĐ/1 giao
            dịch).
          </p>
          <p className="mt-2 mb-1">
            (***) Đối với FE Credit: Đơn vị phát hành thẻ sẽ thu thêm phí chuyển
            đổi giao dịch trả góp (thu một lần và chưa bao gồm VAT) của chủ thẻ
            như sau:
          </p>
      ...
      <div className="mt-10">
        ...
        <div className="text-left ml-6">
          ...
          <p className="mb-1 mt-2">
            {" "}
            👉 Khách hàng có thể thanh toán số tiền trả góp trước kỳ hạn vào bất
            kỳ lúc nào. Trong trường hợp này, lãi suất 0% vẫn được áp dụng cho
            số tiền trả góp của khách hàng.
          </p>
          <span className="font-semibold">
            - Khi gặp sự cố các vấn đề tín dụng , mình cần gặp ai để được xử lí
            ?
          </span>
          <p className="mb-1 mt-2">
            {" "}
            👉 Khi gặp sự cố, quý khách hàng xin vui lòng liên hệ với bộ phận hỗ
            trợ khách hàng MPOS, số điện thoại 1900.63.64.88.
          </p>
          <span className="font-semibold">
          ...
          <p className="mb-1 mt-2">
            {" "}
            👉 Chương trình “Trả Góp Lãi Suất 0%” được lựa chọn áp dụng tại các
            điểm kinh doanh của CN PC.
          </p>
        </div>
      </div>
      {/* question usually asked */}
